...
![Image of Yaktocat](Normal_calendarheatmap.png)

{{< figure src="Normal_calendarheatmap.png" title="Other calendar heatmap" >}}

The aim of this post is to create a calendar heatmap that has the format exactly like a normal caldendar like this:

{{< figure src="featured.png" title="Optimal calendar heatmap" >}}

{{< figure library="1" src="./calendarheatmap_files/figure-html/calendarheatmap -1.png" title="A caption" >}}
